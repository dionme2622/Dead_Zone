...
#pragma region Player1
	...
	//player1->AddComponent(make_shared<BoxCollider>(Vec3(0,0,0),Vec3(1,1,1)));										// Capsule Collider 생성

	player1->AddComponent(make_shared<RigidBody>(50.0f, dynamic_pointer_cast<CapsuleCollider>(player1->GetCollider()), mat, false));			// Rigid Body 생성
