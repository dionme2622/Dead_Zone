...
#pragma region Player2
	...
	//shared_ptr<MeshData> FemaleHero_data = GET_SINGLE(Resources)->LoadModelFromBinary(L"..\\Resources\\Model\\SA_Character_FemaleHero_noAnimation.bin"); // MeshData* meshData
